...
* Moving from File based system to save replied comments to a database which stores the replied to comment id.
* Expanding player database to involve players not only from the Premier League, but also the top european clubs.
